...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 w-full h-18.75 bg-white border-t-2 border-b border-gray-200 shadow-md">
      {/* ================= MAIN CONTAINER ================= */}
      <div className="max-w-384 h-full mx-auto px-6 py-4 flex items-center">
        <div className="w-full flex items-center">
          {/* ================= LOGO ================= */}
          <button
            onClick={() => navigate("/")}
            className="logo w-[147.625px] h-8 font-['Inter','Inter_Fallback'] text-left cursor-pointer"
          >
            <span className="text-[#172033] text-[24px] font-normal">
              BLOOM
            </span>

            <span className="text-[#F5A000] text-[24px] font-normal">SHOP</span>
          </button>
          ...
          {/* ================= RIGHT SIDE ================= */}
          <div className="right-side flex items-center gap-2 md:gap-6.75">
            {/* ================= MOBILE SEARCH ICON ================= */}
            <button
              onClick={() => {
              ...
              className="md:hidden w-10 h-10 flex items-center justify-center rounded-full text-[#172033] hover:text-[#F5A000] hover:bg-gray-100 cursor-pointer"
            >
              <svg
                width="22"
                height="22"
  ...
  >
    ...
    {cartCount > 0 && (
      <span
        ...
        bg-[#F5A000] text-black text-[11px] font-bold
      ...
      >
        {cartCount}
            ...
            {/* ================= DESKTOP SIGN IN ================= */}
            <div className="hidden md:block sign-in">
              <button className="px-3 py-2 rounded-full text-[14px] text-black hover:text-[#F5A000] hover:bg-[#FFF3E0] cursor-pointer">
                Sign In
              </button>
            </div>

            {/* ================= DESKTOP SIGN UP ================= */}
            <div className="hidden md:block sign-up">
              <button className="text-[14px] text-black bg-[#F5A000] px-4.25 py-2 rounded-full shadow-md hover:bg-[#E89500] cursor-pointer">
                Sign Up
              </button>
            </div>
          ...
          <div className="w-full h-10 border border-[#d3d8e0] focus-within:border-[1.5px] focus-within:border-black rounded-full flex items-center">
            ...
            <div className="flex-1">
              <input
                type="text"
                placeholder="Search products..."
                className="w-full h-full pl-3 pr-3 outline-none text-[15px] text-gray-700 placeholder:text-[#a0a5ad] font-medium"
              />
            </div>
          </div>
        </div>
      ...
      {menuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-gray-200 shadow-md z-50">
          <div className="px-6 py-4 flex flex-col items-center gap-2">
            ...
            <a
              href="#"
              className="w-full text-center px-4 py-3 rounded-lg text-[15px] text-[#172033] hover:text-[#F5A000] hover:bg-[#FFF3E0]"
            >
              Contact
            </a>

            {/* Sign In */}
            <button className="w-full text-center px-4 py-3 rounded-lg text-[15px] text-[#172033] hover:text-[#F5A000] hover:bg-[#FFF3E0]">
              Sign In
            </button>

            {/* Sign Up */}
            <button className="w-full text-center px-4 py-3 rounded-lg text-[15px] text-black bg-[#F5A000] hover:bg-[#E89500]">
              Sign Up
            </button>
          </div>
        </div>
